<x-app-layout>
    <x-slot name="header">
        ...
        <div class = " mt-4 ml-4">
            <form action="/meeting/member" method="POST">
                @csrf
                <button type="button" class="bg-green-700 hover:bg-green-600 text-white rounded px-4 py-2" onclick="location.href='./member/make'">アカウント発行</button>
                <button type="button" class="bg-green-700 hover:bg-green-600 text-white rounded px-4 py-2" onclick="location.href='./member/tag'">タグ管理</button>
                <select name="tag" >
