<x-app-layout>
    <x-slot name="header">
        ...
        <form method = "GET" action = "?">
            ...
            <div class = "menu">
                <button type = "submit" value = "enchant" formaction = "/meeting/client/member/tag/enchant">タグ付与</button>
                <button type = "submit" value = "delete" formaction = "/meeting/client/member/tag/delete">タグ削除</button>
            </div>
        </form>
