<x-app-layout>
    <x-slot name="header">
        ...
        <form method = "GET" action = "?">
            ...
            <div class = "menu mt-4 ml-4">
                <button class="bg-green-700 hover:bg-green-600 text-white rounded px-4 py-2" type = "submit" value = "enchant" formaction = "/meeting/client/member/tag/enchant">タグ付与</button>
                <button class="bg-green-700 hover:bg-green-600 text-white rounded px-4 py-2" type = "submit" value = "delete" formaction = "/meeting/client/member/tag/delete">タグ削除</button>
            </div>
        </form>
        
        <br/>
        <dev class ="footer">
            <a href = "/meeting/client/member" class ="mt-4 ml-4 footer bg-gray-100 text-gray-800 text-1xl font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-gray-700 dark:text-gray-400 border border-gray-500">戻る</a>
        </dev>
