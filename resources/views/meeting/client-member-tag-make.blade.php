<x-app-layout>
    <x-slot name="header">
        ...
        <div class = "footer">
            <br/>
            <a href = "/meeting/client/member/tag" class ="mt-4 ml-4 footer bg-gray-100 text-gray-800 text-1xl font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-gray-700 dark:text-gray-400 border border-gray-500">戻る</a>
        </div>
